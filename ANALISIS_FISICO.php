...
<body>                        
		...
		<div style="margin-left: 100px; margin-right:100px;">    
                        ...
                        <?php
                            $regi = mysqli_query($conexion, "select  *from compra A where Not exists (select * from analisisfisico B where B.codigo_analisisfisico = A.marca) and A.municipio_compra = '$_SESSION[municipio]'") or die("Problemas en el select:" . mysqli_error($conexion));
    ...
    { 
     ...
     var destare = document.getElementById("destare").value
      ...
      if (almendra_total == "" || almendra_sana == "" || broca == "" || broca_punto == "" || negro == "" || vinagre == "" || humedad == "" || destare == ""){

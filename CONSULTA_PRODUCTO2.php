...
mysqli_query($conexion,"insert into producto2 (tipo, precio, descripcion, prima_producto, politica, nombre, fecha) values ('$_POST[tipo]', $_POST[precio], '$_POST[descripcion]', $_POST[prima_producto],'$_POST[politica]','$_POST[nombre]','$fecha')");       

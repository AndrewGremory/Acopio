...
<div  class=" text-center">
		...
		<div style="margin-left: 100px; margin-right:100px;">    
                        ...
                        <?php
                            ...
                            $regi = mysqli_query($conexion, "select  *from compra A where Not exists (select *from analisissensorial B where A.marca = B.codigo_sensorial) and A.municipio_compra = '$_SESSION[municipio]'") or die("Problemas en el select:" . mysqli_error($conexion));
                            while ($consu = mysqli_fetch_array($regi)) 
                            {                           
                        ?>        
                        <option label="<?php echo $consu['nombre_compra'].' '. $consu['nombre_compra']?>"   value="<?php echo $consu['marca']?>" >

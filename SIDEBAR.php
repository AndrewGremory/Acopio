  ...
  <body>
		...
		<div >
          ...
          <a style="margin-left: 75px;" href = ""> <img  src = "anei.png "></a >
		  		...
		  		<a href="TARJETAS.PHP" target="cesar" class="img rounded-circle logo mb-5"  style="background-image: url(sol.png);" ></a>
	        ...
	        <ul class="list-unstyled components mb-5">
              ...
              <div style="margin-top: 3px;"> <a href="#formulariosSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">REGISTROS</a></div>
                ...
                <?php
                if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "analista fisico") 
                {?>
                <li>
                ...
                <?php } ?>
                <?php
                if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "analista sensorial") 
                {?>
                <li>
                ...
                <?php } ?>
                <?php
                if ($_SESSION['rol'] == "administrador"  || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador") 
                {?>
                <li>
                ...
                <?php } ?>
                <?php
                if ($_SESSION['rol'] == "analista fisico" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "administrador") 
                {?>
                <li>
                 <a href="FIJAR.php" target="cesar">Fijar Precio</a>
                </li>
                <?php } ?>
                <?php
                if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "liquidador") 
                {?>
               <li>
                <a href="SECADORA.php" target="cesar">Crear Lotes</a>
               </li>
               <?php } ?>
                <?php
                if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "contador") 
                {?>
               <li>
               ...
               if ($_SESSION['rol'] == "administrador") 
                {?>
               <li>
                <a href="USUARIOS.php" target="cesar">Usuarios</a>
               </li>
               <?php } ?>
	            </ul>
	          </li>
              ...
              <?php
               if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "gerente" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "analista fisico" || $_SESSION['rol'] == "analista sensorial" || $_SESSION['rol'] == "contador" || $_SESSION['rol'] == "analista") 
                {?>
                <li>
               ...
               if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "gerente" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "analista fisico" || $_SESSION['rol'] == "analista sensorial" || $_SESSION['rol'] == "contador" || $_SESSION['rol'] == "analista") 
                {?>
                <li>
                    <a href="CONSULTA_PRODUCTO3.php" target="cesar">Historial de Precios</a>
                </li>
                <?php } ?>
                <?php
               if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "gerente" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "analista fisico" || $_SESSION['rol'] == "analista sensorial" || $_SESSION['rol'] == "contador" || $_SESSION['rol'] == "analista") 
                ...
                <?php } ?>
                <?php
               if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "recibo" || $_SESSION['rol'] == "gerente" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador"|| $_SESSION['rol'] == "analista fisico" || $_SESSION['rol'] == "analista sensorial" || $_SESSION['rol'] == "contador" || $_SESSION['rol'] == "analista") 
                {?>
                <li>
               ...
               if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "gerente" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "analista fisico" || $_SESSION['rol'] == "analista sensorial" || $_SESSION['rol'] == "contador" || $_SESSION['rol'] == "analista") 
                {?>
                <li>
                  <a href="CONSULTA_FIJAR.php" target="cesar">Precios Fijados</a>
                </li>
                <?php } ?>
                <?php
               if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "gerente" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "analista fisico" || $_SESSION['rol'] == "analista sensorial" || $_SESSION['rol'] == "contador" || $_SESSION['rol'] == "analista") 
                {?>
                <li>
                  <a href="CONSULTA_SECADORA4.php" target="cesar">Lotes</a>
                </li>
                <?php } ?>
                <?php
               if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "gerente" || $_SESSION['rol'] == "subadministrador" || $_SESSION['rol'] == "liquidador" || $_SESSION['rol'] == "analista fisico" || $_SESSION['rol'] == "analista sensorial" || $_SESSION['rol'] == "contador" || $_SESSION['rol'] == "analista") 
               ...
               if ($_SESSION['rol'] == "administrador" || $_SESSION['rol'] == "gerente") 
                {?>
                <li>
                  <a href="CONSULTA_USUARIOS.php" target="cesar">Usuarios</a>
                </li>
                <?php } ?>
              </ul>
	          </li>
            <li>
              ...
              <ul class="collapse list-unstyled" id="pageSubmenu">
                ...
                <li>
                    <a href="CERRAR.php" target="_blank">Finalizar Sesion</a>
                </li>
              </ul>
            </li>

...
<!-- ----------------- COMPRAR --------------------------------->  
  function compra()
  {
     ...
     var numero_estopas = document.getElementById("numero_estopas").value
     var estado_estopas = document.getElementById("estado_estopas").value
     var numero_sacos = document.getElementById("numero_sacos").value
     var estado_sacos = document.getElementById("estado_sacos").value
     var kilos_brutos = document.getElementById("kilos_brutos").value
     var latas_compra = document.getElementById("latas_compra").value
     var kilos_netos = document.getElementById("kilos_netos").value

...
<div class="container text-center">
		...
		<div class="row text-center">
                        ...
                        <?php                        
                        $regi = mysqli_query($conexion, "select  *from compra A where Not exists (select * from liquidacion B where A.marca = B.codigo_liquidacion) and A.municipio_compra = '$_SESSION[municipio]' ") or die("Problemas en el select:" . mysqli_error($conexion));
...
function liquidacion()
{
  ...
  var kilos_liquidacion = document.getElementById("kilos_liquidacion").value
             
      if (bonificacion == "" || aporte == "" || ahorro == "" || kilos_liquidacion == ""){
      ...
      var parametros = 
      {
        ...
        "municipio_liquidacion" : $("#municipio_liquidacion").val(),
        "accion":"12"
      };
